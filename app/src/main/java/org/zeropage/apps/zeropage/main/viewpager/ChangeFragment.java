 ...
 */
public class ChangeFragment extends WebViewFragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_chnage, container, false);
        initWebView(view, R.id.change_webview, "http://wiki.zeropage.org/wiki.php/FrontPage");
